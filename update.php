...
$stuid = $_GET['updateid'];
$sql = "select * from student_table where id= $stuid";
...
if(isset($_POST['btn'])){
      ...
      $email=$_POST['email'];
      $course=$_POST['pos'];
      $sql = "update student_table set id= $stuid, firstname= '$fname', lastname= '$lname', email= '$email', pos='$course' 
      where id = $stuid";
...
<form method="post">
    ...
    <input type="text" name="pos" class="form-control" placeholder="Enter the Student Program" autocomplete="off"
